...
#         col9 = diffusion confined, col10 = d diffusion confined
#         """
#         self.rossier_info = np.zeros([np.size(trajectories), 8])
#         i = 0
#         for trajectory in trajectories:
#             print(trajectory.analyse_successful, type(trajectory.analyse_successful))
#             self.rossier_info[i,0] = trajectory.trajectory_number 
# # =============================================================================
# #             if trajectory.immobility:
# #                 self.rossier_info[i,1] = trajectory.immobility
...
# # =============================================================================
#             self.rossier_info[i,1] = trajectory.tau
#             self.rossier_info[i,2] = trajectory.dtau
#             self.rossier_info[i,3] = trajectory.r
#             self.rossier_info[i,4] = trajectory.dr
#             self.rossier_info[i,5] = trajectory.D_conf
#             self.rossier_info[i,6] = trajectory.dD_conf
#             self.rossier_info[i,7] = trajectory.analyse_successful
#             i += 1
#         print(self.rossier_info)
#         print(type(self.rossier_info[:,7]), self.rossier_info[:,7])
# =============================================================================
